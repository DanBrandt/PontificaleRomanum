...
\begin{center}
	\textbf{\Huge De Confirmandis et Professionem Fidei Catholicae a Neo-Conversis}\\
...
\rubric{\color{red}The priest vests in surplice and purple stole, and sits in front of the altar predella on the Epistle side. The convert is kneeling before him. The convert then makes the Profession of Faith.}
...
{\color{red}\textit{The priest, with the convert, then rises and they both approach the credence table and sign the Church documents recording the Confirmation. While this occurs, the Cantors chant Psalm 50 and/or Psalm 129.}}
...
\rubric{\color{red}The convert remains kneeling, while the priest, seated, recites Psalm 50 or Psalm 129 in a hushed tone. After the `Gloria Patri', he rises and leads the following audibly so all may hear it:}
...
\latinenglishequal{
	...
	{\color{red}\Vbar.} Salvum fac servum tuum.
	...
	{\color{red}\Vbar.} Save Thy servant.
...
\rubric{\color{red}The priest sits and pronounces the absolution from excommunication, inserting the word `perhaps' (forsan) if there is doubt as to whether or not it has been incurred (this is spoken, and not chanted):}
